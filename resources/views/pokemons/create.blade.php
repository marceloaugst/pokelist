                                        ...
                                        <div class="rounded-xl bg-slate-700/30 p-5">
                                            ...
                                            <table class="pokedex-table">
                                                <tr>
                                                    <th>Nº Nacional</th>
                                                    <td><span
                                                            class="font-bold text-blue-400">{{ str_pad($pokemonData['id'], 4, '0', STR_PAD_LEFT) }}</span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th>Tipo</th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ number_format($pokemonData['height'], 1) }} m
                                                        ({{ floor($pokemonData['height'] * 3.28084) }}'{{ str_pad(round(($pokemonData['height'] * 39.3701) % 12), 2, '0', STR_PAD_LEFT) }}")
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th>Peso</th>
                                                    ...
                                                    <td>
                                                        @if (!empty($pokemonData['abilities']))
                                                            @foreach ($pokemonData['abilities'] as $index => $ability)
                                                                <div>
                                                                    <span
                                                                        class="text-slate-400">{{ $index + 1 }}.</span>
                                                                    <span
                                                                        class="{{ $ability['is_hidden'] ? 'text-purple-400' : 'text-blue-400' }}">{{ $ability['name'] }}</span>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-sm">
                                                            ...
                                                            @foreach ($localNumbers as $dex => $number)
                                                                <span
                                                                    class="text-slate-300">{{ str_pad($number, 3, '0', STR_PAD_LEFT) }}</span>
                                                                <span
                                                                    class="text-slate-500">({{ ucwords(str_replace('-', '/', $dex)) }})</span>
                                                                @if (!$loop->last)
                                                                    ,
                                                                @endif
                                                            @endforeach
                                            ...
                                            <table class="pokedex-table">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <span
                                                            class="text-xs text-slate-500">({{ number_format(($pokemonData['catch_rate'] / 255) * 100, 1) }}%
                                                ...
                                                <tr>
                                                    ...
                                                    <td><span
                                                            class="text-cyan-400">{{ $pokemonData['growth_rate'] }}</span>
                                                    </td>
                                                </tr>
                                            </table>
                                        </div>
                                        ...
                                        @foreach ($pokemonData['evolution_chain'] as $index => $evo)
                                            <div class="flex items-center">
                                                ...
                                                <div
                                                    ...
                                                    <span
                                                        class="text-xs text-slate-500">#{{ str_pad($evo['id'], 3, '0', STR_PAD_LEFT) }}</span>
                                                </div>
                                                ...
                                                @if (!$loop->last)
                                                    <div class="mx-2 flex flex-col items-center">
                                                        ...
                                                        @if ($nextEvo && $nextEvo['evolution_details'])
                                                            <span
                                                                class="mt-1 rounded bg-slate-600 px-2 py-1 text-xs text-slate-300">
                                    ...
                                    <div id="interactive-chart"
                                        ...
                                        <div class="relative mx-auto" style="width: 350px; height: 350px;">
                                            <svg id="stats-chart" width="350" height="350" viewBox="0 0 350 350"
                                                ...
                                                <!-- Grid circles -->
                                                @for ($i = 1; $i <= 5; $i++)
                                                    <circle cx="175" cy="175" r="{{ $i * 25 }}"
                                                        fill="none" stroke="#475569" stroke-width="1" />
                                                @endfor

                                                <!-- Axis lines -->
                                                <line x1="175" y1="175" x2="175" y2="50"
                                                    stroke="#64748b" stroke-width="1" />
                                                <line x1="175" y1="175" x2="280" y2="113"
                                                    stroke="#64748b" stroke-width="1" />
                                                <line x1="175" y1="175" x2="237" y2="263"
                                                    stroke="#64748b" stroke-width="1" />
                                                <line x1="175" y1="175" x2="113" y2="263"
                                                    stroke="#64748b" stroke-width="1" />
                                                <line x1="175" y1="175" x2="70" y2="113"
                                                    stroke="#64748b" stroke-width="1" />

                                                <!-- Base stats polygon (blue) -->
                                                <polygon id="base-polygon" fill="rgba(59, 130, 246, 0.3)"
                            ...
                            <div class="lg:order-2">
                                <form method="POST" action="{{ route('pokemons.store') }}" class="space-y-6"
                                    ...
                                    @foreach ($pokemonData['stats'] as $statName => $statValue)
                                        <input type="hidden" name="base_{{ $statName }}"
                                            value="{{ $statValue }}">
                                    @endforeach
                                    ...
                                    <input type="hidden" name="catch_rate"
                                        value="{{ $pokemonData['catch_rate'] ?? '' }}">
                                    ...
                                    <input type="hidden" name="growth_rate"
                                        value="{{ $pokemonData['growth_rate'] ?? '' }}">
                                    ...
                                    <input type="hidden" name="egg_cycles"
                                        value="{{ $pokemonData['egg_cycles'] ?? '' }}">
                                    ...
                                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                                        <div>
                                            ...
                                            <input type="text" name="game_name" id="game_name" required
                                                placeholder="Ex: Pokémon Red, Pokémon Sword..."
                                        ...
                                        <div>
                                            <label for="level"
                                                class="mb-2 block text-sm font-medium text-slate-300">Nível *</label>
                                    ...
                                    <div>
                                        ...
                                        <div class="space-y-6">
                                            @foreach (['hp' => 'HP', 'attack' => 'Ataque', 'defense' => 'Defesa', 'sp_attack' => 'Ataque Especial', 'speed' => 'Velocidade'] as $statName => $statLabel)
                                                    ...
                                                    <div class="flex gap-4">
                                                        <div class="flex-1">
                                                            <input type="number" name="game_{{ $statName }}"
                                                                id="game_{{ $statName }}" min="0"
                                                                max="999" required placeholder="Digite o valor"
