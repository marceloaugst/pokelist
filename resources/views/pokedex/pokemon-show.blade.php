<x-public-layout>
  ...
  <div class="py-8">
    <div class="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
      ...
      <div
        class="pokemon-detail-card mb-8 overflow-hidden border border-slate-700 bg-slate-800/50 shadow-xl backdrop-blur-sm rounded-2xl">
        <div class="p-8">
          <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="text-center">
              <div
                class="pokemon-sprite-container relative mx-auto mb-6 flex h-48 w-48 items-center justify-center rounded-full bg-gradient-to-br from-slate-700 to-slate-800 shadow-lg shadow-slate-900/50 ring-4 ring-slate-600">
                  ...
                  <div class="flex-1">
                    <div class="flex items-center gap-3">
                      <div class="flex-1 bg-slate-700 rounded-full h-3 overflow-hidden">
                        <div
                          class="{{ $config['color'] }} status-bar h-full rounded-full transition-all duration-1000 ease-out"
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
        ...
        <!-- Treinamento -->
        <div
          class="pokemon-detail-card overflow-hidden border border-slate-700 bg-slate-800/50 shadow-xl backdrop-blur-sm rounded-2xl">
          <div class="p-6">
            ...
            <div class="space-y-4">
              ...
              <div class="flex justify-between items-center">
                ...
                <span class="text-white font-semibold">{{ ucfirst(str_replace('-', ' ', $pokemonData['growth_rate'] ??
                  'N/A')) }}</span>
              </div>

              @if(isset($pokemonData['ev_yield']) && !empty($pokemonData['ev_yield']) && $pokemonData['ev_yield'] !==
              'None')
              <div>
                ...
                <div class="flex flex-wrap gap-1">
                  ...
                  echo '<span class="bg-blue-600 text-white px-2 py-1 rounded text-xs">' . htmlspecialchars($evItem) .
                    '</span>';
                  }
                  }
                  @endphp
        ...
        <div
          ...
          <div class="p-6">
            ...
            <div class="space-y-3">
              ...
              'Muito Pouco Eficaz (0.25x)' => collect($pokemonData['type_defenses'])->filter(fn($v) => $v ==
              0.25)->keys(),
        ...
        <div class="p-6">
          ...
          <div class="w-full overflow-x-auto pb-2">
            <div class="flex items-stretch justify-center gap-0 min-w-max px-4">
              ...
              <div class="flex flex-col items-center">
                <a href="{{ route('pokedex.pokemon.show', $evolution['id']) }}"
                  ...
                  <div class="relative">
                    ...
                    <div
                      class="relative w-24 h-24 mx-auto mb-3 flex items-center justify-center rounded-full bg-gradient-to-br from-slate-700 to-slate-800 shadow-lg shadow-slate-900/50 ring-2 ring-slate-600 group-hover:ring-blue-500 transition-all duration-300">
                  ...
                  <div
                    class="text-white font-semibold text-sm group-hover:text-blue-400 transition-colors duration-200">
              ...
              @if($index < count($pokemonData['evolution_chain']) - 1) <div
                class="flex items-center flex-shrink-0 mx-2">
                <div class="flex items-center justify-center h-full">
                  <svg class="w-8 h-8 text-slate-500 group-hover:text-slate-300 transition-colors duration-200"
